...
import { digest } from 'file:///app/node_modules/nitropack/node_modules/ohash/dist/index.mjs';
...
import { Youch } from 'file:///app/node_modules/nitropack/node_modules/youch/build/index.js';
...
import { isVNode, toValue, isRef } from 'file:///app/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///app/node_modules/pathe/dist/index.mjs';
import { basename } from 'file:///app/node_modules/@nuxt/icon/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///app/node_modules/@iconify/utils/lib/index.mjs';
import { hash as hash$1 } from 'file:///app/node_modules/@nuxt/icon/node_modules/ohash/dist/index.mjs';
import { collections } from 'file:///app/.nuxt/nuxt-icon-server-bundle.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "apiBaseUrl": "http://localhost:9218/api/v1",
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"title":"ESGMATE"};
...
const _GLgqf1EBUhaLrB9EnbFLKSA6C7L8f_DQrUNRy4VAg5I = (nitroApp) => {
...
const _E0LLhNjKQn_mEGb6XaXlumPYzHdVK8aFOvSEDgOlOc = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
_GLgqf1EBUhaLrB9EnbFLKSA6C7L8f_DQrUNRy4VAg5I,
_E0LLhNjKQn_mEGb6XaXlumPYzHdVK8aFOvSEDgOlOc
];
...
const _HbowGA = defineCachedEventHandler(async (event) => {
...
const _lazy_qh6Orl = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _oStzCE, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_qh6Orl, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _HbowGA, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_qh6Orl, lazy: true, middleware: false, method: undefined }
];
