var _a;
import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, computed, nextTick, onScopeDispose, watch, toRefs, defineComponent, createElementBlock, provide, cloneVNode, h, resolveComponent, defineAsyncComponent, unref, Suspense, mergeProps, Fragment, withCtx, createVNode, useSSRContext, resolveDynamicComponent, createTextVNode, toDisplayString, readonly, onErrorCaptured, onServerPrefetch, createApp } from "vue";
import { $fetch as $fetch$1 } from "ofetch";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Jarvis/17_idea/project_management/frontend/src/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Jarvis/17_idea/project_management/frontend/src/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "C:/Jarvis/17_idea/project_management/frontend/src/node_modules/h3/dist/index.mjs";
...
import { toRouteMatcher, createRouter } from "C:/Jarvis/17_idea/project_management/frontend/src/node_modules/radix3/dist/index.mjs";
import { defu, defuFn, createDefu } from "C:/Jarvis/17_idea/project_management/frontend/src/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "C:/Jarvis/17_idea/project_management/frontend/src/node_modules/ufo/dist/index.mjs";
import { klona } from "C:/Jarvis/17_idea/project_management/frontend/src/node_modules/klona/dist/index.mjs";
import { createSharedComposable } from "@vueuse/core";
import { extendTailwindMerge } from "tailwind-merge";
import { useHead as useHead$1, headSymbol } from "C:/Jarvis/17_idea/project_management/frontend/src/node_modules/@unhead/vue/dist/index.mjs";
import { _api, addAPIProvider, setCustomIconsLoader } from "@iconify/vue";
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderClass, ssrRenderVNode, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderSuspense } from "vue/server-renderer";
import { ChevronDownIcon, QuestionMarkCircleIcon, CogIcon, ChartBarIcon, ArrowRightOnRectangleIcon, ChevronLeftIcon, XMarkIcon, Bars3Icon, ChevronRightIcon, MagnifyingGlassIcon, GlobeAltIcon, SunIcon, MoonIcon, BellIcon, WrenchScrewdriverIcon, InformationCircleIcon, ShieldExclamationIcon, DocumentTextIcon, UserPlusIcon, ExclamationCircleIcon, FolderIcon, ArrowRightIcon, HomeIcon, UsersIcon, CheckIcon } from "@heroicons/vue/24/outline";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-_orNPGQA.js")
  },
  {
    name: "profile",
    path: "/profile",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/profile-CM_yff84.js")
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": "guest" } },
    component: () => import("./_nuxt/login-7KOZioO0.js")
  },
  {
    name: "help",
    path: "/help",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-Bw-ECUHA.js")
  },
  {
    name: "settings-ui",
    path: "/settings/ui",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/ui-DSLmqfGF.js")
  },
  {
    name: "auth-register",
    path: "/auth/register",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": "guest" } },
    component: () => import("./_nuxt/register-DviMnxdC.js")
  },
  {
    name: "clients",
    path: "/clients",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-Dg51kw5u.js")
  },
  {
    name: "clients-create",
    path: "/clients/create",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/create-D9VUJMRF.js")
  },
  {
    name: "projects",
    path: "/projects",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-D-SR6kuM.js")
  },
  {
    name: "settings",
    path: "/settings",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/index-DHitTSZ1.js")
  },
  {
    name: "settings-theme",
    path: "/settings/theme",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/theme-DvHz2dvM.js")
  },
  {
    name: "settings-users",
    path: "/settings/users",
    meta: { "middleware": "admin" },
    component: () => import("./_nuxt/users-p3NElDIx.js")
  },
  {
    name: "projects-create",
    path: "/projects/create",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/create-CfYn_zZx.js")
  },
  {
    name: "dashboard-analytics",
    path: "/dashboard/analytics",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/analytics-CE28hZLu.js")
  }
];
...
const namedMiddleware = {
  admin: () => import("./_nuxt/admin-hl85HoFd.js"),
  auth: () => import("./_nuxt/auth-Dzu3cK3e.js"),
  guest: () => import("./_nuxt/guest-DelWA1xe.js")
};
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-DET6PmNp.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-DXW8eE0m.js").then((m) => m.default || m))
};
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative" }, _attrs))}><button class="${ssrRenderClass([{ "justify-center": __props.collapsed }, "w-full flex items-center px-3 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-all duration-200 group"])}">`);
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(getIcon(__props.item.icon)), { class: "w-5 h-5 text-gray-500 group-hover:text-primary-500 transition-colors duration-200" }, null), _parent);
      if (!__props.collapsed) {
        _push(`<div class="flex items-center justify-between flex-1 ml-3"><span class="font-medium">${ssrInterpolate(__props.item.name)}</span>`);
        if (__props.item.children) {
          _push(ssrRenderComponent(unref(ChevronDownIcon), {
            class: ["w-4 h-4 transition-transform duration-200", { "rotate-180": unref(isExpanded) }]
          }, null, _parent));
        } else {
          _push(`<!---->`);
        }
      ...
      _push(`</button>`);
      if (__props.collapsed) {
        _push(`<div class="absolute left-full top-0 ml-2 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50 whitespace-nowrap">${ssrInterpolate(__props.item.name)}</div>`);
      } else {
        _push(`<!---->`);
      }
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-27111c3e><aside class="${ssrRenderClass([[
        unref(sidebarCollapsed) ? "w-20" : "w-70"
      ], "fixed top-0 left-0 h-full bg-white dark:bg-gray-800 shadow-lg transition-all duration-300 z-40 hidden lg:block flex flex-col"])}" data-v-27111c3e><div class="h-16 flex items-center justify-center border-b border-gray-200 dark:border-gray-700" data-v-27111c3e>`);
      if (!unref(sidebarCollapsed)) {
        _push(`<div class="text-xl font-bold text-gray-800 dark:text-white" data-v-27111c3e> Admin Panel </div>`);
      } else {
        _push(`<div class="w-8 h-8 bg-primary-500 rounded-lg flex items-center justify-center" data-v-27111c3e><span class="text-white font-bold text-sm" data-v-27111c3e>A</span></div>`);
      }
      _push(`</div><nav class="flex-1 px-4 py-6 space-y-2" data-v-27111c3e><!--[-->`);
      ...
      _push(`<!--]--></nav><div class="p-4 border-t border-gray-200 dark:border-gray-700" data-v-27111c3e><button class="${ssrRenderClass([{ "justify-center": unref(sidebarCollapsed) }, "w-full flex items-center px-3 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200"])}" data-v-27111c3e>`);
      _push(ssrRenderComponent(unref(ArrowRightOnRectangleIcon), { class: "w-5 h-5" }, null, _parent));
      if (!unref(sidebarCollapsed)) {
        _push(`<span class="ml-3" data-v-27111c3e>登出</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</button></div><button class="absolute -right-3 top-6 w-6 h-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full flex items-center justify-center hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200" data-v-27111c3e>`);
      _push(ssrRenderComponent(unref(ChevronLeftIcon), {
        class: ["w-4 h-4 text-gray-500 transition-transform duration-200", { "rotate-180": unref(sidebarCollapsed) }]
      }, null, _parent));
      _push(`</button></aside>`);
      if (unref(sidebarMobileOpen)) {
        _push(`<div class="fixed inset-0 bg-black bg-opacity-50 z-40 lg:hidden" data-v-27111c3e></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<aside class="${ssrRenderClass([[
        unref(sidebarMobileOpen) ? "translate-x-0" : "-translate-x-full"
      ], "fixed top-0 left-0 h-full w-70 bg-white dark:bg-gray-800 shadow-lg transition-transform duration-300 z-50 lg:hidden flex flex-col"])}" data-v-27111c3e><div class="h-16 flex items-center justify-between px-4 border-b border-gray-200 dark:border-gray-700" data-v-27111c3e><div class="text-xl font-bold text-gray-800 dark:text-white" data-v-27111c3e> Admin Panel </div><button class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg" data-v-27111c3e>`);
      _push(ssrRenderComponent(unref(XMarkIcon), { class: "w-5 h-5" }, null, _parent));
      _push(`</button></div><nav class="flex-1 px-4 py-6 space-y-2" data-v-27111c3e><!--[-->`);
      ssrRenderList(unref(menuItems), (item) => {
        _push(ssrRenderComponent(_component_SidebarMenuItem, {
          key: item.name,
          item,
      ...
      _push(`<!--]--></nav><div class="p-4 border-t border-gray-200 dark:border-gray-700" data-v-27111c3e><button class="w-full flex items-center px-3 py-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200" data-v-27111c3e>`);
      _push(ssrRenderComponent(unref(ArrowRightOnRectangleIcon), { class: "w-5 h-5" }, null, _parent));
      _push(`<span class="ml-3" data-v-27111c3e>登出</span></button></div></aside></div>`);
    };
  }
};
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-27111c3e"]]);
const useI18n = () => {
  const locale = useState("locale", () => "zh-TW");
  const translations = {
    "zh-TW": () => import("./_nuxt/zh-TW-D1vc__r3.js").then((m) => m.default),
    "en": () => import("./_nuxt/en-CQ9WJudz.js").then((m) => m.default),
    "ja": () => import("./_nuxt/ja-1i-umakd.js").then((m) => m.default)
  };
  ...
  const apiRequest = async (endpoint, options = {}) => {
    ...
    try {
      ...
      if (errorDetails.status === 404) {
        ...
        errorDetails.message = ((_c = error.data) == null ? void 0 : _c.message) || "表單驗證失敗";
...
const useAuthStore = /* @__PURE__ */ defineStore("auth", () => {
  ...
  const register = async (userData) => {
    ...
    try {
      ...
      if (!response.success) {
        const errorMessage = ((_a2 = response.error) == null ? void 0 : _a2.message) || "註冊失敗";
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$2;
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 flex items-center justify-between" }, _attrs))}><div class="flex items-center space-x-4"><button class="lg:hidden p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">`);
      ...
      _push(`<!--]--></ol></nav></div></div><div class="flex items-center space-x-3"><button class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200 relative">`);
      _push(ssrRenderComponent(unref(MagnifyingGlassIcon), { class: "w-5 h-5" }, null, _parent));
      _push(`</button><div class="relative"><button class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200">`);
      ...
      _push(`</div><button class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200">`);
      if (unref(isDark)) {
      ...
      _push(`</button><div class="relative"><button class="p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200 relative">`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-gray-50 dark:bg-gray-900 flex" }, _attrs))} data-v-0cb10d15>`);
      _push(ssrRenderComponent(_component_AppSidebar, null, null, _parent));
      _push(`<div class="${ssrRenderClass([{
        "sidebar-collapsed": unref(sidebarCollapsed)
      }, "min-h-screen flex flex-col flex-1 main-content-area"])}" data-v-0cb10d15>`);
      _push(ssrRenderComponent(_component_AppNavbar, null, null, _parent));
      _push(`<main class="flex-1 flex items-center justify-center p-6" data-v-0cb10d15><div class="text-center max-w-2xl mx-auto" data-v-0cb10d15><div class="bg-white dark:bg-gray-800 rounded-lg-custom shadow-sm p-12" data-v-0cb10d15><div class="mb-8" data-v-0cb10d15><h1 class="text-9xl font-bold text-primary-500 leading-none select-none" data-v-0cb10d15>${ssrInterpolate(unref(errorCode))}</h1></div><div class="mb-8" data-v-0cb10d15><div class="relative inline-flex items-center justify-center" data-v-0cb10d15>`);
      _push(ssrRenderComponent(unref(FolderIcon), { class: "w-24 h-24 text-gray-300 dark:text-gray-600" }, null, _parent));
      _push(`<div class="absolute -top-2 -right-2 bg-primary-500 rounded-full w-10 h-10 flex items-center justify-center" data-v-0cb10d15>`);
      _push(ssrRenderComponent(unref(QuestionMarkCircleIcon), { class: "w-6 h-6 text-white" }, null, _parent));
      _push(`</div></div></div><div class="mb-8 space-y-2" data-v-0cb10d15><h2 class="text-2xl font-bold text-gray-900 dark:text-white" data-v-0cb10d15>${ssrInterpolate(unref(t)("error.page_not_found"))}</h2><p class="text-lg text-gray-600 dark:text-gray-300" data-v-0cb10d15>${ssrInterpolate(unref(t)("error.page_not_found_en"))}</p><p class="text-gray-500 dark:text-gray-400" data-v-0cb10d15>${ssrInterpolate(unref(t)("error.page_description"))}</p></div><div class="mb-8" data-v-0cb10d15><div class="relative max-w-md mx-auto" data-v-0cb10d15><input${ssrRenderAttr("value", unref(searchQuery))} type="text"${ssrRenderAttr("placeholder", unref(t)("error.search_placeholder"))} class="w-full pl-12 pr-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all duration-200" data-v-0cb10d15><div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none" data-v-0cb10d15>`);
      _push(ssrRenderComponent(unref(MagnifyingGlassIcon), { class: "h-5 w-5 text-gray-400" }, null, _parent));
      _push(`</div><button class="absolute inset-y-0 right-0 pr-3 flex items-center" data-v-0cb10d15>`);
      ...
      _push(`</button></div></div><div class="space-y-6" data-v-0cb10d15><div data-v-0cb10d15>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
      ...
      _push(`</div><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" data-v-0cb10d15>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
      ...
      _push(`</div><div class="pt-6 border-t border-gray-200 dark:border-gray-700" data-v-0cb10d15><p class="text-sm text-gray-500 dark:text-gray-400" data-v-0cb10d15>${ssrInterpolate(unref(t)("error.helpful_tips"))}</p><div class="mt-3 space-y-2" data-v-0cb10d15><div class="flex items-center text-xs text-gray-400 dark:text-gray-500" data-v-0cb10d15>`);
      _push(ssrRenderComponent(unref(CheckIcon), { class: "w-4 h-4 mr-2 text-primary-500" }, null, _parent));
      _push(` ${ssrInterpolate(unref(t)("error.tip_1"))}</div><div class="flex items-center text-xs text-gray-400 dark:text-gray-500" data-v-0cb10d15>`);
      _push(ssrRenderComponent(unref(CheckIcon), { class: "w-4 h-4 mr-2 text-primary-500" }, null, _parent));
      _push(` ${ssrInterpolate(unref(t)("error.tip_2"))}</div><div class="flex items-center text-xs text-gray-400 dark:text-gray-500" data-v-0cb10d15>`);
      _push(ssrRenderComponent(unref(CheckIcon), { class: "w-4 h-4 mr-2 text-primary-500" }, null, _parent));
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-0cb10d15"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
export {
  ...
  useSidebarStore as l,
  __nuxt_component_0 as m,
  navigateTo as n,
  _sfc_main$3 as o,
  _sfc_main$2 as p,
  storeToRefs as s,
