import { defineComponent, shallowRef, h, resolveComponent, ref, watch, computed, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createVNode, resolveDynamicComponent, toRaw, isRef, isReactive, toRef, hasInjectionContext, inject, getCurrentInstance, reactive, effectScope, getCurrentScope, onScopeDispose, nextTick, toRefs, markRaw, createElementBlock, provide, cloneVNode, defineAsyncComponent, shallowReactive, Suspense, Fragment, useSSRContext, readonly, createApp, onErrorCaptured, onServerPrefetch, isReadonly, isShallow } from 'vue';
import { k as parseQuery, i as createError$1, l as klona, m as defuFn, n as hasProtocol, o as isScriptProtocol, q as joinURL, w as withQuery, r as sanitizeStatusCode, v as withTrailingSlash, x as withoutTrailingSlash, y as getContext, $ as $fetch$1, z as baseURL, A as defu, B as createHooks, C as executeAsync, D as toRouteMatcher, E as createRouter$1 } from '../_/nitro.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { createSharedComposable } from '@vueuse/core';
import { extendTailwindMerge } from 'tailwind-merge';
import { _api, addAPIProvider, setCustomIconsLoader } from '@iconify/vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderVNode, ssrRenderAttr, ssrRenderSuspense } from 'vue/server-renderer';
import { Bars3Icon, ChevronRightIcon, MagnifyingGlassIcon, GlobeAltIcon, SunIcon, MoonIcon, BellIcon, ChevronDownIcon, WrenchScrewdriverIcon, InformationCircleIcon, ShieldExclamationIcon, DocumentTextIcon, UserPlusIcon, ExclamationCircleIcon, ArrowRightOnRectangleIcon, ChevronLeftIcon, XMarkIcon, QuestionMarkCircleIcon, CogIcon, ChartBarIcon, FolderIcon, ArrowRightIcon, HomeIcon, UsersIcon, CheckIcon } from '@heroicons/vue/24/outline';
...
const _routes = [
  {
    ...
    component: () => import('./index-_orNPGQA.mjs')
  },
  {
    name: "profile",
    path: "/profile",
    meta: { "middleware": "auth" },
    component: () => import('./profile-CM_yff84.mjs')
  },
  {
    name: "auth-login",
    path: "/auth/login",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": "guest" } },
    component: () => import('./login-7KOZioO0.mjs')
  },
  {
    name: "help",
    path: "/help",
    meta: { "middleware": "auth" },
    component: () => import('./index-Bw-ECUHA.mjs')
  },
  {
    name: "settings-ui",
    path: "/settings/ui",
    meta: { "middleware": "auth" },
    component: () => import('./ui-DSLmqfGF.mjs')
  },
  {
    name: "auth-register",
    path: "/auth/register",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": "guest" } },
    component: () => import('./register-DviMnxdC.mjs')
  },
  {
    name: "clients",
    path: "/clients",
    meta: { "middleware": "auth" },
    component: () => import('./index-Dg51kw5u.mjs')
  },
  {
    name: "clients-create",
    path: "/clients/create",
    meta: { "middleware": "auth" },
    component: () => import('./create-D9VUJMRF.mjs')
  },
  {
    name: "projects",
    path: "/projects",
    meta: { "middleware": "auth" },
    component: () => import('./index-D-SR6kuM.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    meta: { "middleware": "auth" },
    component: () => import('./index-DHitTSZ1.mjs')
  },
  {
    name: "settings-theme",
    path: "/settings/theme",
    meta: { "middleware": "auth" },
    component: () => import('./theme-DvHz2dvM.mjs')
  },
  {
    name: "settings-users",
    path: "/settings/users",
    meta: { "middleware": "admin" },
    component: () => import('./users-p3NElDIx.mjs')
  },
  {
    name: "projects-create",
    path: "/projects/create",
    meta: { "middleware": "auth" },
    component: () => import('./create-CfYn_zZx.mjs')
  },
  {
    name: "dashboard-analytics",
    path: "/dashboard/analytics",
    meta: { "middleware": "auth" },
    component: () => import('./analytics-CE28hZLu.mjs')
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-hl85HoFd.mjs'),
  auth: () => import('./auth-Dzu3cK3e.mjs'),
  guest: () => import('./guest-DelWA1xe.mjs')
};
...
const LazyIcon = defineAsyncComponent(() => import('./index-DET6PmNp.mjs').then((r) => r["default"] || r.default || r));
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DXW8eE0m.mjs').then((m) => m.default || m))
};
...
export { __nuxt_component_0$2 as _, useI18n as a, useAuthStore as b, useHead as c, useSettingsStore as d, entry$1 as default, useTheme as e, defineNuxtRouteMiddleware as f, createError as g, useNuxtApp as h, asyncDataDefaults as i, useAppConfig as j, useRuntimeConfig as k, useSidebarStore as l, __nuxt_component_0 as m, navigateTo as n, _sfc_main$3 as o, _sfc_main$2 as p, storeToRefs as s, useApi as u };
