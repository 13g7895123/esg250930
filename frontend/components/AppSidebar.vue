        ...
        >
          ...
          <div v-if="!sidebarCollapsed" key="expanded" class="flex flex-col items-center">
            ...
            <div v-else class="text-center">
              ...
              <!-- Secondary name hidden per requirement -->
...
const { websiteName, showLogo, logoUrl, displaySecondaryName } = storeToRefs(websiteSettingsStore)

// Use app title from environment for consistency
const config = useRuntimeConfig()
const displayName = computed(() => config.public.appTitle)
